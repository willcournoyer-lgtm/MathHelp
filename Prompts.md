...
Now, in the game model, add a section of information called "Division". in this section, for each question, generate a whole number 1-20, store that whole number in a variable, multiply it by another number of 1-20. Then put the product of the two numbers, into the previously mentioned variable. Show that variable, then divided by the second generated number. make it so that the user can type in a number, if the entered answer is the correct answer (which should be the second generated number), do the following orders of add to total correct, and correct in a row. Then fully rewrite the game files that you adjust so i can copy and past them with all the previous content we had discussed.

Now, in the game model, add a section of information called "Exponents". in this section, for each question, generate a whole number between 0 and 20, then have them raised to the power 2. make it so that the user can type in a number, if the entered answer is the correct answer, do the following orders of add to total correct, and correct in a row. Then fully rewrite the game files that you adjust so i can copy and past them with all the previous content we had discussed.